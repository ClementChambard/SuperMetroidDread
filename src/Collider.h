...
class Collider {
    public:
        ...
        Collider& setSize(const glm::vec2& size) { this->size = size; return *this; }
        Collider& setPos (const glm::vec2& pos ) { this->pos  = pos ; return *this; }
        Collider& Update(glm::vec2& speed);

        Collider& Draw() { NSEngine::draw_quad_2d(topleft(), topright(), bottomright(), bottomleft()); return *this; }
